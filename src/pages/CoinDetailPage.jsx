...
const CoinDetailPage = () => {
  ...
  return (
    <div className="coin-app-detail mt-20 grid content-center grid-cols-3">
      <div className="header-div">
        <h1 className="coin-text">Cryptocurrency Data</h1>
      </div>
      ...
      <CoinHeader
        ...
        priceChange={coinData.coin && coinData.coin.price_change_percentage_24h}
        marketcap={coinData.coin && coinData.coin && coinData.coin.market_cap}
      />

      <div className="chart-div p-3 rounded-lg m-auto col-span-3 w-11/12 mt-3 ">
